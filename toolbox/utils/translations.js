 ...
 */
export const APP_EDIT_TRANSLATIONS = {
  action_uninstall: {
    "en-US": "Uninstall",
    "zh-CN": "卸载",
    "zh-TW": "卸載",
...
/**
 * App list screen translations
 */
export const APP_LIST_TRANSLATIONS = {
  title_apps: {
    "en-US": "Apps",
    "zh-CN": "应用",
    "zh-TW": "應用",
 ...
 * File edit screen
 */
export const FILE_EDIT_TRANSLATIONS = {
  file_view_as_image: {
    "en-US": "View as image",
    "zh-CN": "以图片形式查看",
    "zh-TW": "以圖片形式檢視",
...
export const TIMER_TRANSLATIONS = {
  timer_start: {
    "en-US": "Begin",
    "zh-CN": "开始",
    "zh-TW": "開始",
...
/**
 * Quick settings tile names
 * Visible when editing homepage
 */
export const QS_TILE_NAMES = {
  qs_apps: {
    "en-US": "Apps manager",
    "zh-CN": "应用管理器",
    "zh-TW": "應用管理器",
